            ...
            <form id="site-search" method="post" action="{$_url}services/pppoe">
                <div class="panel-body">
                    <div class="row row-no-gutters" style="padding: 5px">
                        ...
                        <div class="col-lg-1 col-xs-4">
                            <a href="{$_url}services/static-ip-add" class="btn btn-primary btn-block"
                    ...
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <tbody>
                            {foreach $d as $ds}
                                ...
                                <td>{$ds['device']}</td>
                                <td>
                                    <a href="{$_url}services/static-ip-edit/{$ds['id']}"
                                        class="btn btn-info btn-xs">{Lang::T('Edit')}</a>
                                    <a href="{$_url}services/static-ip-delete/{$ds['id']}"
